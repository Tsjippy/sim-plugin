...
add_action( 'wp_enqueue_scripts', function ($hook) {
    ...
    //Load js
	wp_register_script('sim_frontend_script', plugins_url('js/frontend_posting.js', __DIR__), array('sim_fileupload_script', 'sim_formsubmit_script'), ModuleVersion, true);
