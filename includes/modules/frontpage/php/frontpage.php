...
if(!empty($hookName)){
	...
	add_action($hookName, function(){
		if (is_user_logged_in() && SIM\isHomePage(get_the_ID())){
...
if(!empty($hookName)){
	add_action($hookName, function(){
		...
		if(SIM\isHomePage(get_the_ID()) && is_user_logged_in()){
...
if(!empty($hookName)){
	add_action($hookName, function() {
		...
		if (!SIM\isHomePage(get_the_ID()) || !is_user_logged_in() && SIM\isHomePage(get_the_ID(), false)){
			return;
		}
