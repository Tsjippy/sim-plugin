...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php generate_do_microdata( 'article' ); ?>>
	<div class="cat_card<?php if(!$archive) echo ' inside-article';?>">
		...
		<div class='entry-content<?php if($archive) echo ' archive';?>'>
			...
			<div class='author'>
				Shared by: <a href='<?php echo get_missionary_page_url(get_the_author_meta('ID')) ?>'><?php the_author(); ?></a>
			</div>
			...
			<div class='recipe metas'>
				...
				<span class='category recipemeta'> 
					...
					$url = plugins_url().'/custom-simnigeria-plugin/includes/pictures/recipe_category.png';
				...
				<span class='cooking_time recipemeta'>
					<?php 
					$url = plugins_url().'/custom-simnigeria-plugin/includes/pictures/recipe_coocking_time.png';
					echo "<img src='$url' alt='category' class='recipe_icon'>";
