...
add_action('frontend_post_save_meta','SIM\save_location_meta',10,2);
...
function save_location_meta($post_id, $post_type){
	//store locationtype
	$locationtypes = [];
	if(is_array($_POST['locationtype'])){
		...
		wp_set_post_terms($post_id,$locationtypes,'locationtype');
	}
	...
	location_address($locationtypes, $post_id);
}
